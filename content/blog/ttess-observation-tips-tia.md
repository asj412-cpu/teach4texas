---
title: "T-TESS Observation Tips: How to Score Distinguished for TIA Designation"
description: "A domain-by-domain breakdown of the T-TESS rubric with specific strategies for scoring Distinguished — the observation scores that earn TIA designation."
keywords: ["T-TESS distinguished tips", "T-TESS observation prep", "TIA observation scores", "T-TESS rubric breakdown", "T-TESS domains"]
date: 2026-02-18
...
1. **Planning** (Domain 1)
2. **Instruction** (Domain 2)
3. **Learning Environment** (Domain 3)
4. **Professional Practices and Responsibilities** (Domain 4)
...
*For the complete picture on TIA, read our [TIA Complete Guide](/blog/tia-complete-guide). To strengthen the student growth side of your TIA evaluation, check out [How STAAR Scores Connect to TIA Designation](/blog/staar-scores-tia-designation). And download our [TIA Portfolio Guide](/templates/tia-portfolio-guide) to keep your evidence organized.*
